...
import sys
import time
import unidecode #for encode the all characters this is require
dataFile = ""
...
links = browser.find_elements_by_class_name("_5rgt")

while linkCount > len(links):
      htmlPage = browser.find_element_by_tag_name("html")
      for i in range(20):
          time.sleep(0.1)
...
links = browser.find_elements_by_class_name("_5rgt")
postLink = browser.find_elements_by_class_name("_5msj")
postTime = browser.find_elements_by_class_name("_36xo")
counter =0
for i in links:
